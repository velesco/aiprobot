...
const CONFIG_KEY = Symbol.for("aipro:testConfigMock");
...
vi.mock("@whiskeysockets/baileys", () => {
  ...
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("aipro:lastSocket")] = created.lastSocket;
  return created.mod;
});
...
export function resetBaileysMocks() {
  ...
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("aipro:lastSocket")] =
...
export function getLastSocket(): MockBaileysSocket {
  const getter = (globalThis as Record<PropertyKey, unknown>)[Symbol.for("aipro:lastSocket")];
  if (typeof getter === "function") {
