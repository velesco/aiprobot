...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AIProConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AIProConfig; env: NodeJS.ProcessEnv }): {
  cfg: AIProConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
