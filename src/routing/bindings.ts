...
export function listBindings(cfg: AIProConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: AIProConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: AIProConfig) {
