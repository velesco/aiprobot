...
function resolveAnthropicDefaultAuthMode(cfg: AIProConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AIProConfig): AIProConfig {
...
export function applyTalkApiKey(config: AIProConfig): AIProConfig {
...
export function applyModelDefaults(cfg: AIProConfig): AIProConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AIProConfig): AIProConfig {
...
export function applyLoggingDefaults(cfg: AIProConfig): AIProConfig {
...
export function applyContextPruningDefaults(cfg: AIProConfig): AIProConfig {
...
export function applyCompactionDefaults(cfg: AIProConfig): AIProConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
