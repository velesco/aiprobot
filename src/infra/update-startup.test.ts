...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "aipro-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveAIProPackageRoot } = await import("./aipro-root.js");
    ...
    vi.mocked(resolveAIProPackageRoot).mockResolvedValue("/opt/aipro");
