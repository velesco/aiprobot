...
const execHostEnforced = process.env.AIPRO_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.AIPRO_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
