 ...
 *
 * @see https://github.com/aipro/aipro/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an AIProConfig.
 */
export function timestampOptsFromConfig(cfg: AIProConfig): TimestampInjectionOptions {
  return {
