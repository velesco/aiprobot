...
${formatHelpExamples([
  ['aipro message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'aipro message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'aipro message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.aipro.ro/cli/message")}`,
    )
    .action(() => {
