...
function resolveForegroundMs(cfg: AIProConfig): number {
...
export async function handleBashChatCommand(params: {
  ...
  if (params.cfg.commands?.bash !== true) {
    return {
      text: "⚠️ bash is disabled. Set commands.bash=true to enable. Docs: https://docs.aipro.ro/tools/slash-commands#config",
    };
  }
