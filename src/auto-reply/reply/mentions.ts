...
function resolveMentionPatterns(cfg: AIProConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: AIProConfig | undefined, agentId?: string): RegExp[] {
