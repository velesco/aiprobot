...
export const DEFAULT_LOG_DIR = "/tmp/aipro";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "aipro.log"); // legacy single-file path

const LOG_PREFIX = "aipro";
...
function resolveSettings(): ResolvedSettings {
  let cfg: AIProConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => AIProConfig;
      };
