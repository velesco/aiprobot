...
export function resolveTtsConfig(cfg: AIProConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.AIPRO_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: AIProConfig): string | undefined {
