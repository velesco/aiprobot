...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.AIPRO_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: AIProConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: AIProConfig): string {
...
function mergeTelegramAccountConfig(cfg: AIProConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: AIProConfig): ResolvedTelegramAccount[] {
