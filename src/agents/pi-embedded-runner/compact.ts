...
import { resolveAIProDocsPath } from "../docs-path.js";
...
export async function compactEmbeddedPiSessionDirect(
  ...
  const agentDir = params.agentDir ?? resolveAIProAgentDir();
  await ensureAIProModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createAIProCodingTools({
      exec: {
    ...
    const docsPath = await resolveAIProDocsPath({
      workspaceDir: effectiveWorkspace,
