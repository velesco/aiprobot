...
function resolveAvatarSource(cfg: AIProConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AIProConfig, agentId: string): AgentAvatarResolution {
