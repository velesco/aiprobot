...
describe("createAIProCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createAIProCodingTools({
      config,
    ...
    const anthropicTools = createAIProCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createAIProCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createAIProCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
