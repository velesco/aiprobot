...
function resolveConfiguredModelRaw(cfg: AIProConfig): string {
...
function resolveConfiguredModelKeys(cfg: AIProConfig): string[] {
...
export function applyPrimaryModel(cfg: AIProConfig, model: string): AIProConfig {
...
export function applyModelAllowlist(cfg: AIProConfig, models: string[]): AIProConfig {
  const defaults = cfg.agents?.defaults;
