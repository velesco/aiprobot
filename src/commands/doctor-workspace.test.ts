...
describe("detectLegacyWorkspaceDirs", () => {
  it("ignores ~/aipro when it doesn't look like a workspace (e.g. install dir)", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/clawd";
    const candidate = path.join(home, "aipro");
  ...
  it("flags ~/aipro when it contains workspace markers", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/clawd";
    const candidate = path.join(home, "aipro");
