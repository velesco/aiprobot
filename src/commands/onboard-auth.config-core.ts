...
export function applyZaiConfig(cfg: AIProConfig): AIProConfig {
...
export function applyOpenrouterProviderConfig(cfg: AIProConfig): AIProConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: AIProConfig): AIProConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: AIProConfig): AIProConfig {
...
export function applyMoonshotConfig(cfg: AIProConfig): AIProConfig {
...
export function applyKimiCodeConfig(cfg: AIProConfig): AIProConfig {
...
export function applySyntheticProviderConfig(cfg: AIProConfig): AIProConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: AIProConfig): AIProConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: AIProConfig): AIProConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: AIProConfig): AIProConfig {
