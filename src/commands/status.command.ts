...
export async function statusCommand(
  ...
  runtime.log(theme.heading("AIPro status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("aipro security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("aipro security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.aipro.ro/faq");
  runtime.log("Troubleshooting: https://docs.aipro.ro/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("aipro status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("aipro logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("aipro status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("aipro gateway probe")}`);
  }
}
