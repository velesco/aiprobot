...
This page ties together how AIPro handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. AIPro keeps a
...
AIPro separates the **prompt body** from the **command body**:
...
AIPro can expose or hide model reasoning:
