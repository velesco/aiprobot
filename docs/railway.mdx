...
Deploy AIPro on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/aipro-railway-template" target="_blank" rel="noreferrer">Deploy on Railway</a>
...
- `https://<your-railway-domain>/aipro` — Control UI

## What you get

- Hosted AIPro Gateway + Control UI
...
- `DIGIBOSS_STATE_DIR=/data/.aipro` (recommended)
- `DIGIBOSS_WORKSPACE_DIR=/data/workspace` (recommended)
- `DIGIBOSS_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your AIPro state + workspace so you can migrate to another host without losing config or memory.
