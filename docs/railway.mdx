...
<a href="https://railway.com/deploy/aipro-railway-template" target="_blank" rel="noreferrer">
  Deploy on Railway
</a>
...
- `AIPRO_STATE_DIR=/data/.aipro` (recommended)
- `AIPRO_WORKSPACE_DIR=/data/workspace` (recommended)
- `AIPRO_GATEWAY_TOKEN` (recommended; treat as an admin secret)
