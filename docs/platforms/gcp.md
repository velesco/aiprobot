---
summary: "Run AIPro Gateway 24/7 on a GCP Compute Engine VM (Docker) with durable state"
read_when:
...
Run a persistent AIPro Gateway on a GCP Compute Engine VM using Docker, with durable state, baked-in binaries, and safe restart behavior.

If you want "AIPro 24/7 for ~$5-12/mo", this is a reliable setup on Google Cloud.
