---
summary: "Run AIPro Gateway 24/7 on a cheap Hetzner VPS (Docker) with durable state and baked-in binaries"
read_when:
  - You want AIPro running 24/7 on a cloud VPS (not your laptop)
