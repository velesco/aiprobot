...
- Install via CLI: `aipro plugins install @aipro/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `aipro plugins install ./extensions/zalo`
   - From npm (if published): `aipro plugins install @aipro/zalo`
...
- Approve via:
  - `aipro pairing list zalo`
  - `aipro pairing approve zalo <CODE>`
...
- Example: `aipro message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `aipro channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `aipro logs --follow`
