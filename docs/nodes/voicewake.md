...
AIPro treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.aipro/settings/voicewake.json`

Shape:

```json
{ "triggers": ["aipro", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
