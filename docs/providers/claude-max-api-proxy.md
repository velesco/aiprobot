...
You can point AIPro at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or AIPro
...
- [Anthropic provider](/providers/anthropic) - Native AIPro integration with Claude setup-token or API keys
