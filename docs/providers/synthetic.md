---
summary: "Use Synthetic's Anthropic-compatible API in AIPro"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. AIPro registers it as the
...
Note: AIPro's Anthropic client appends `/v1` to the base URL, so use
