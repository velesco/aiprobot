---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with AIPro"
read_when:
  - You want Xiaomi MiMo models in AIPro
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). AIPro uses
