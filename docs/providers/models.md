---
summary: "Model providers (LLMs) supported by AIPro"
read_when:
...
AIPro can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `aipro onboard`).
