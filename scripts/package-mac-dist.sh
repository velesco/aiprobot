...
# Output:
# - dist/AIPro.app
# - dist/AIPro-<version>.zip
# - dist/AIPro-<version>.dmg
...
ZIP="$ROOT_DIR/dist/AIPro-$VERSION.zip"
DMG="$ROOT_DIR/dist/AIPro-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/AIPro-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/AIPro-$VERSION.dSYM.zip"
