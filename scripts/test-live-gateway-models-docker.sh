...
docker run --rm -t \
  ...
  -e AIPRO_LIVE_TEST=1 \
  -e AIPRO_LIVE_GATEWAY_MODELS="${AIPRO_LIVE_GATEWAY_MODELS:-all}" \
  -e AIPRO_LIVE_GATEWAY_PROVIDERS="${AIPRO_LIVE_GATEWAY_PROVIDERS:-}" \
  -e AIPRO_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${AIPRO_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}" \
