...
CDP_PORT="${AIPRO_BROWSER_CDP_PORT:-9222}"
VNC_PORT="${AIPRO_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${AIPRO_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${AIPRO_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${AIPRO_BROWSER_HEADLESS:-0}"
