...
export function listGoogleChatAccountIds(cfg: AIProConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: AIProConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: AIProConfig): ResolvedGoogleChatAccount[] {
