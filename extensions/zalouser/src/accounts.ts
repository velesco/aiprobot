...
export function listZalouserAccountIds(cfg: AIProConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: AIProConfig): string {
...
function mergeZalouserAccountConfig(cfg: AIProConfig, accountId: string): ZalouserAccountConfig {
