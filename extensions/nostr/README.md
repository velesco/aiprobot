...
Nostr DM channel plugin for AIPro using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to AIPro. It enables your bot to:
...
# Configure aipro to use local relay
