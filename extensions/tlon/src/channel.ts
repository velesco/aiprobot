...
const tlonOutbound: ChannelOutboundAdapter = {
  ...
  sendText: async ({ cfg, to, text, accountId, replyToId, threadId }) => {
    const account = resolveTlonAccount(cfg as AIProConfig, accountId ?? undefined);
...
export const tlonPlugin: ChannelPlugin = {
  ...
  config: {
    listAccountIds: (cfg) => listTlonAccountIds(cfg as AIProConfig),
    resolveAccount: (cfg, accountId) => resolveTlonAccount(cfg as AIProConfig, accountId ?? undefined),
  ...
  setup: {
    ...
    validateInput: ({ cfg, accountId, input }) => {
      ...
      const resolved = resolveTlonAccount(cfg as AIProConfig, accountId ?? undefined);
