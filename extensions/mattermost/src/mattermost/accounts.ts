...
export function listMattermostAccountIds(cfg: AIProConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: AIProConfig): string {
...
export function listEnabledMattermostAccounts(cfg: AIProConfig): ResolvedMattermostAccount[] {
