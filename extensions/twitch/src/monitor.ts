...
import type { ReplyPayload, AIProConfig } from "aipro/plugin-sdk";
import { createReplyPrefixOptions } from "aipro/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as AIProConfig;
