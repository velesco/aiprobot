...
export function listBlueBubblesAccountIds(cfg: AIProConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: AIProConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: AIProConfig): ResolvedBlueBubblesAccount[] {
