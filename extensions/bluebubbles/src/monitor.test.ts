...
import { removeAckReactionAfterReply, shouldAckReaction } from "aipro/plugin-sdk";
import type { AIProConfig, PluginRuntime } from "aipro/plugin-sdk";
import {
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/aipro") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
