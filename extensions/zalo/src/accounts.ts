...
function mergeZaloAccountConfig(cfg: AIProConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: AIProConfig): ResolvedZaloAccount[] {
