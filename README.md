# 🦞 AIPro — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/aipro/aipro/main/docs/assets/aipro-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/aipro/aipro/main/docs/assets/aipro-logo-text.png" alt="AIPro" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/aipro/aipro/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/aipro/aipro/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/aipro/aipro/releases"><img src="https://img.shields.io/github/v/release/aipro/aipro?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**AIPro** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://aipro.ro) · [Docs](https://docs.aipro.ro) · [DeepWiki](https://deepwiki.com/aipro/aipro) · [Getting Started](https://docs.aipro.ro/start/getting-started) · [Updating](https://docs.aipro.ro/install/updating) · [Showcase](https://docs.aipro.ro/start/showcase) · [FAQ](https://docs.aipro.ro/start/faq) · [Wizard](https://docs.aipro.ro/start/wizard) · [Nix](https://github.com/aipro/nix-aipro) · [Docker](https://docs.aipro.ro/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`aipro onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.aipro.ro/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.aipro.ro/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.aipro.ro/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.aipro.ro/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.aipro.ro/start/getting-started)

```bash
aipro onboard --install-daemon

aipro gateway --port 18789 --verbose

# Send a message
aipro message send --to +1234567890 --message "Hello from AIPro"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
aipro agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.aipro.ro/install/updating) (and run `aipro doctor`).
...
Switch channels (git + npm): `aipro update --channel stable|beta|dev`.
Details: [Development channels](https://docs.aipro.ro/install/development-channels).
...
pnpm aipro onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm aipro ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `aipro` binary.

## Security defaults (DM access)

AIPro connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.aipro.ro/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `aipro pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `aipro doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.aipro.ro/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.aipro.ro/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.aipro.ro/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.aipro.ro/nodes/voicewake) + [Talk Mode](https://docs.aipro.ro/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.aipro.ro/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.aipro.ro/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.aipro.ro/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.aipro.ro/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.aipro.ro/nodes).
- **[Onboarding](https://docs.aipro.ro/start/wizard) + [skills](https://docs.aipro.ro/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=aipro/aipro&type=date&legend=top-left)](https://www.star-history.com/#aipro/aipro&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.aipro.ro/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.aipro.ro/web), and [Canvas host](https://docs.aipro.ro/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.aipro.ro/tools/agent-send): gateway, agent, send, [wizard](https://docs.aipro.ro/start/wizard), and [doctor](https://docs.aipro.ro/gateway/doctor).
- [Pi agent runtime](https://docs.aipro.ro/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.aipro.ro/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.aipro.ro/concepts/groups).
- [Media pipeline](https://docs.aipro.ro/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.aipro.ro/nodes/audio).

### Channels

- [Channels](https://docs.aipro.ro/channels): [WhatsApp](https://docs.aipro.ro/channels/whatsapp) (Baileys), [Telegram](https://docs.aipro.ro/channels/telegram) (grammY), [Slack](https://docs.aipro.ro/channels/slack) (Bolt), [Discord](https://docs.aipro.ro/channels/discord) (discord.js), [Google Chat](https://docs.aipro.ro/channels/googlechat) (Chat API), [Signal](https://docs.aipro.ro/channels/signal) (signal-cli), [BlueBubbles](https://docs.aipro.ro/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.aipro.ro/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.aipro.ro/channels/msteams) (extension), [Matrix](https://docs.aipro.ro/channels/matrix) (extension), [Zalo](https://docs.aipro.ro/channels/zalo) (extension), [Zalo Personal](https://docs.aipro.ro/channels/zalouser) (extension), [WebChat](https://docs.aipro.ro/web/webchat).
- [Group routing](https://docs.aipro.ro/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.aipro.ro/channels).

### Apps + nodes

- [macOS app](https://docs.aipro.ro/platforms/macos): menu bar control plane, [Voice Wake](https://docs.aipro.ro/nodes/voicewake)/PTT, [Talk Mode](https://docs.aipro.ro/nodes/talk) overlay, [WebChat](https://docs.aipro.ro/web/webchat), debug tools, [remote gateway](https://docs.aipro.ro/gateway/remote) control.
- [iOS node](https://docs.aipro.ro/platforms/ios): [Canvas](https://docs.aipro.ro/platforms/mac/canvas), [Voice Wake](https://docs.aipro.ro/nodes/voicewake), [Talk Mode](https://docs.aipro.ro/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.aipro.ro/platforms/android): [Canvas](https://docs.aipro.ro/platforms/mac/canvas), [Talk Mode](https://docs.aipro.ro/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.aipro.ro/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.aipro.ro/tools/browser): dedicated aipro Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.aipro.ro/platforms/mac/canvas): [A2UI](https://docs.aipro.ro/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.aipro.ro/nodes): camera snap/clip, screen record, [location.get](https://docs.aipro.ro/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.aipro.ro/automation/cron-jobs); [webhooks](https://docs.aipro.ro/automation/webhook); [Gmail Pub/Sub](https://docs.aipro.ro/automation/gmail-pubsub).
- [Skills platform](https://docs.aipro.ro/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.aipro.ro/concepts/channel-routing), [retry policy](https://docs.aipro.ro/concepts/retry), and [streaming/chunking](https://docs.aipro.ro/concepts/streaming).
- [Presence](https://docs.aipro.ro/concepts/presence), [typing indicators](https://docs.aipro.ro/concepts/typing-indicators), and [usage tracking](https://docs.aipro.ro/concepts/usage-tracking).
- [Models](https://docs.aipro.ro/concepts/models), [model failover](https://docs.aipro.ro/concepts/model-failover), and [session pruning](https://docs.aipro.ro/concepts/session-pruning).
- [Security](https://docs.aipro.ro/gateway/security) and [troubleshooting](https://docs.aipro.ro/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.aipro.ro/web) + [WebChat](https://docs.aipro.ro/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.aipro.ro/gateway/tailscale) or [SSH tunnels](https://docs.aipro.ro/gateway/remote) with token/password auth.
- [Nix mode](https://docs.aipro.ro/install/nix) for declarative config; [Docker](https://docs.aipro.ro/install/docker)-based installs.
- [Doctor](https://docs.aipro.ro/gateway/doctor) migrations, [logging](https://docs.aipro.ro/logging).
...
- **[Gateway WebSocket network](https://docs.aipro.ro/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.aipro.ro/gateway)).
- **[Tailscale exposure](https://docs.aipro.ro/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.aipro.ro/gateway/remote)).
- **[Browser control](https://docs.aipro.ro/tools/browser)** — aipro‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.aipro.ro/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.aipro.ro/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.aipro.ro/nodes/voicewake) + [Talk Mode](https://docs.aipro.ro/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.aipro.ro/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

AIPro can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (AIPro enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.aipro.ro/gateway/tailscale) · [Web surfaces](https://docs.aipro.ro/web)
...
Details: [Remote access](https://docs.aipro.ro/gateway/remote) · [Nodes](https://docs.aipro.ro/nodes) · [Security](https://docs.aipro.ro/gateway/security)
...
Details: [Nodes](https://docs.aipro.ro/nodes) · [macOS app](https://docs.aipro.ro/platforms/macos) · [Gateway protocol](https://docs.aipro.ro/concepts/architecture)
...
Details: [Session tools](https://docs.aipro.ro/concepts/session-tool)
...
- Controlled via `aipro nodes …`.

Runbook: [iOS connect](https://docs.aipro.ro/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.aipro.ro/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.aipro/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.aipro/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.aipro/aipro.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.aipro.ro/gateway/configuration)
...
Details: [Security guide](https://docs.aipro.ro/gateway/security) · [Docker + sandboxing](https://docs.aipro.ro/install/docker) · [Sandbox config](https://docs.aipro.ro/gateway/configuration)

### [WhatsApp](https://docs.aipro.ro/channels/whatsapp)

- Link the device: `pnpm aipro channels login` (stores creds in `~/.aipro/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.aipro.ro/channels/telegram)
...
### [Slack](https://docs.aipro.ro/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.aipro.ro/channels/discord)
...
### [Signal](https://docs.aipro.ro/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.aipro.ro/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.aipro.ro/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.aipro.ro/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.aipro.ro/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.aipro.ro)
- [Read the architecture overview for the gateway + protocol model.](https://docs.aipro.ro/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.aipro.ro/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.aipro.ro/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.aipro.ro/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.aipro.ro/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.aipro.ro/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.aipro.ro/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.aipro.ro/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.aipro.ro/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.aipro.ro/platforms/windows), [Linux](https://docs.aipro.ro/platforms/linux), [macOS](https://docs.aipro.ro/platforms/macos), [iOS](https://docs.aipro.ro/platforms/ios), [Android](https://docs.aipro.ro/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.aipro.ro/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.aipro.ro/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.aipro.ro/gateway/discovery)
- [Bonjour/mDNS](https://docs.aipro.ro/gateway/bonjour)
- [Gateway pairing](https://docs.aipro.ro/gateway/pairing)
- [Remote gateway README](https://docs.aipro.ro/gateway/remote-gateway-readme)
- [Control UI](https://docs.aipro.ro/web/control-ui)
- [Dashboard](https://docs.aipro.ro/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.aipro.ro/gateway/health)
- [Gateway lock](https://docs.aipro.ro/gateway/gateway-lock)
- [Background process](https://docs.aipro.ro/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.aipro.ro/tools/browser-linux-troubleshooting)
- [Logging](https://docs.aipro.ro/logging)

## Deep dives

- [Agent loop](https://docs.aipro.ro/concepts/agent-loop)
- [Presence](https://docs.aipro.ro/concepts/presence)
- [TypeBox schemas](https://docs.aipro.ro/concepts/typebox)
- [RPC adapters](https://docs.aipro.ro/reference/rpc)
- [Queue](https://docs.aipro.ro/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.aipro.ro/tools/skills-config)
- [Default AGENTS](https://docs.aipro.ro/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.aipro.ro/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.aipro.ro/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.aipro.ro/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.aipro.ro/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.aipro.ro/reference/templates/TOOLS)
- [Templates: USER](https://docs.aipro.ro/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.aipro.ro/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.aipro.ro/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.aipro.ro/platforms/mac/voicewake)
- [iOS node](https://docs.aipro.ro/platforms/ios)
- [Android node](https://docs.aipro.ro/platforms/android)
- [Windows (WSL2)](https://docs.aipro.ro/platforms/windows)
- [Linux app](https://docs.aipro.ro/platforms/linux)

## Email hooks (Gmail)

- [docs.aipro.ro/gmail-pubsub](https://docs.aipro.ro/automation/gmail-pubsub)

## Molty

AIPro was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [aipro.ro](https://aipro.ro)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@aipro](https://x.com/aipro)
