## AIPro Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_aipro-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm aipro gateway --port 18789 --verbose
```
