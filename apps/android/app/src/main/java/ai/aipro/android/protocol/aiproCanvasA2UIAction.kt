<<<<<<<< HEAD:apps/android/app/src/main/java/ai/aipro/android/protocol/DigibossCanvasA2UIAction.kt
package ro.aipro.android.protocol
========
package ai.aipro.android.protocol
>>>>>>>> upstream-sync:apps/android/app/src/main/java/ai/aipro/android/protocol/aiproCanvasA2UIAction.kt

import kotlinx.serialization.json.JsonObject
import kotlinx.serialization.json.JsonPrimitive

object AIProCanvasA2UIAction {
  ...
  fun jsDispatchA2UIActionStatus(actionId: String, ok: Boolean, error: String?): String {
    ...
    return "window.dispatchEvent(new CustomEvent('aipro:a2ui-action-status', { detail: { id: \"${idEscaped}\", ok: ${okLiteral}, error: \"${err}\" } }));"
  }
}
