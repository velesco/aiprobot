...
public enum AIProCanvasA2UICommand: String, Codable, Sendable {
...
public struct AIProCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AIProCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
