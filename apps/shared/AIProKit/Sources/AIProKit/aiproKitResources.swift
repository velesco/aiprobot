...
<<<<<<<< HEAD:apps/shared/AIProKit/Sources/AIProKit/DigibossKitResources.swift
public enum AIProKitResources {
    /// Resource bundle for AIProKit.
========
public enum AiproKitResources {
    /// Resource bundle for AiproKit.
>>>>>>>> upstream-sync:apps/shared/AIProKit/Sources/AIProKit/aiproKitResources.swift
    ///
...
<<<<<<<< HEAD:apps/shared/AIProKit/Sources/AIProKit/DigibossKitResources.swift
    private static let bundleName = "AIProKit_AIProKit"
========
    private static let bundleName = "AiproKit_AiproKit"
>>>>>>>> upstream-sync:apps/shared/AIProKit/Sources/AIProKit/aiproKitResources.swift
