...
@MainActor
public struct AIProChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: AIProChatViewModel
    ...
    private var visibleMessages: [AIProChatMessage] {
        let base: [AIProChatMessage]
    ...
    private func mergeToolResults(in messages: [AIProChatMessage]) -> [AIProChatMessage] {
    ...
    private func isToolResultMessage(_ message: AIProChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: AIProChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: AIProChatMessage) -> String {
