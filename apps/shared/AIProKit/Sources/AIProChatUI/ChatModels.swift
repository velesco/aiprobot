...
public typealias AIProPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias AIProPlatformImage = UIImage
#endif

public struct AIProChatUsageCost: Codable, Hashable, Sendable {
...
public struct AIProChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: AIProChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(AIProChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct AIProChatMessageContent: Codable, Hashable, Sendable {
...
public struct AIProChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [AIProChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: AIProChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [AIProChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: AIProChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(AIProChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([AIProChatMessageContent].self, forKey: .content) {
...
public struct AIProChatHistoryPayload: Codable, Sendable {
...
public struct AIProSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct AIProSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [AIProSessionPreviewItem]
}

public struct AIProSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [AIProSessionPreviewEntry]

    public init(ts: Int, previews: [AIProSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct AIProChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct AIProChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct AIProAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct AIProChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct AIProGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct AIProPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: AIProPlatformImage?
...
public struct AIProChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
