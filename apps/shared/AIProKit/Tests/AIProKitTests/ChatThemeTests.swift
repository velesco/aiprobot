...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = AIProChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = AIProChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
