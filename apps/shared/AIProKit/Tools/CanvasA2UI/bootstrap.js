...
import "@a2ui/lit/ui";
import { themeContext } from "@aipro/a2ui-theme-context";
...
class AIProA2UIHost extends LitElement {
  static properties = {
    surfaces: { state: true },
  ...
  static styles = css`
    :host {
      ...
      padding:
        var(--aipro-a2ui-inset-top, 0px)
        var(--aipro-a2ui-inset-right, 0px)
        var(--aipro-a2ui-inset-bottom, 0px)
        var(--aipro-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--aipro-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--aipro-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--aipro-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--aipro-a2ui-empty-top, var(--aipro-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  #handleA2UIAction(evt) {
    ...
    globalThis.__aiproLastA2UIAction = userAction;
