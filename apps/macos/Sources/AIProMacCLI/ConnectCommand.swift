...
struct ConnectOptions {
    ...
    var clientId: String = "aipro-macos"
...
func runConnect(_ args: [String]) async {
    ...
    if opts.help {
        ...
        Options:
          ...
          --json             Emit JSON
          --client-id <id>   Override client id (default: aipro-macos)
    ...
    do {
        ...
        let displayName = opts.displayName ?? Host.current().localizedName ?? "AIPro macOS Debug CLI"
...
private func printConnectOutput(_ output: ConnectOutput, json: Bool) {
    ...
    print("AIPro macOS Gateway Connect")
