...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .aiproSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? AIProPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? AIProPaths.stateDirURL.path
...
extension Notification.Name {
    static let aiproSelectSettingsTab = Notification.Name("aiproSelectSettingsTab")
}
