...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (AIPro token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: AIProOAuthStore.AnthropicOAuthStatus = AIProOAuthStore
...
enum AIProOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let aiproOAuthDirEnv = "AIPRO_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "AIPro OAuth token file not found"
            case .unreadableFile: "AIPro OAuth token file not readable"
            case .invalidJSON: "AIPro OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in AIPro OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "AIPro OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.aiproOAuthDirEnv]?
