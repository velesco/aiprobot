...
enum UIStrings {
    static let welcomeTitle = "Welcome to AIPro"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: AIProOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: AIProChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g aipro@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: AIProChatViewModel(
