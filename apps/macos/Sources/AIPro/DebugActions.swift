...
enum DebugActions {
    private static let verboseDefaultsKey = "aipro.debug.verboseMain"
    private static let sessionMenuLimit = 12
    private static let onboardingSeenKey = "aipro.onboardingSeen"
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "AIPro", body: "Test notification", sound: nil)
    }
