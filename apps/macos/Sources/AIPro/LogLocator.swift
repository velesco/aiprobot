...
enum LogLocator {
    ...
    private static var stdoutLog: URL {
        logDir.appendingPathComponent("aipro-stdout.log")
    }

    private static var gatewayLog: URL {
        logDir.appendingPathComponent("aipro-gateway.log")
    }
    ...
    /// Returns the newest log file under /tmp/aipro/ (rolling or stdout), or nil if none exist.
