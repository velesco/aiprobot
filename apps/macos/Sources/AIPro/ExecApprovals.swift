...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.aipro", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        AIProPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        AIProPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
