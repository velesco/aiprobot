...
enum SessionMenuPreviewLoader {
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> AIProSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: AIProSessionPreviewEntry,
    ...
    private static func cache(payload: AIProSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: AIProChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
    ...
    private static func previewText(for message: AIProChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: AIProChatMessage) -> Bool {
    ...
    private static func toolNames(for message: AIProChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: AIProChatMessage) -> String? {
