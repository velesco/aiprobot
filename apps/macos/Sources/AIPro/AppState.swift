...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = AIProConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = AIProConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = AIProConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/aipro"
        state.remoteCliPath = ""
        return state
    }
}
