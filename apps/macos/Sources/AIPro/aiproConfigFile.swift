<<<<<<<< HEAD:apps/macos/Sources/AIPro/DigibossConfigFile.swift
import AIProProtocol
import Foundation

enum AIProConfigFile {
    private static let logger = Logger(subsystem: "ro.aipro", category: "config")
========
import AiproProtocol
import Foundation

enum AIProConfigFile {
    private static let logger = Logger(subsystem: "ai.aipro", category: "config")
>>>>>>>> upstream-sync:apps/macos/Sources/AIPro/aiproConfigFile.swift
