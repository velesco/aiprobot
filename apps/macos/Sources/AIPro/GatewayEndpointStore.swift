...
actor GatewayEndpointStore {
    ...
    private static let staticLogger = Logger(subsystem: "ai.aipro", category: "gateway-endpoint")
    ...
    private let logger = Logger(subsystem: "ai.aipro", category: "gateway-endpoint")
