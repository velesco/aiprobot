...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ro.aipro", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return AIProConfigFile.defaultWorkspaceURL() }
